...
from grok2api.core.exceptions import AppException, ErrorType, UpstreamException, ValidationException
...
from grok2api.services.grok.services.video import (
    VideoCollectProcessor,
    _to_upstream_video_resolution,
)
...
class VideoExtendService:
    ...
    async def extend(
        *,
        ...
        if not token_info:
            raise no_token_error(VIDEO_MODEL_ID)
