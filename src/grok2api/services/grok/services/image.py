...
from grok2api.core.storage import DATA_DIR
from grok2api.core.exceptions import AppException, ErrorType, UpstreamException
from grok2api.services.grok.utils.process import BaseProcessor
...
from grok2api.services.grok.services.image_edit import (
...
from grok2api.services.reverse.ws_imagine import ImagineWebSocketReverse
...
class ImageGenerationService:
    ...
    def _normalize_generation_prompt(prompt: str) -> str:
        return f"{_IMAGE_PROMPT_PREFIX}{str(prompt or '').strip()}"
    ...
    def _app_chat_request_overrides(
        ...
        overrides: Dict[str, Any] = {
            ...
            # Force the request down the image path instead of web-search/tool cards.
            "disableSearch": True,
        }
    ...
    async def generate(
        ...
        *,
        ...
        prompt = self._normalize_generation_prompt(prompt)
