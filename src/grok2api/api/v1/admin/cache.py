...
from grok2api.core.batch import create_task, expire_task
from grok2api.services.grok.batch_services.assets import ListService, DeleteService
...
async def cache_stats(request: Request):
    """获取缓存统计"""
    from grok2api.services.grok.utils.cache import CacheService
